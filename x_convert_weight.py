...
if __name__ == "__main__":
    ...
    parser.add_argument("path", default="data_chk/network-snapshot-000182.pkl", metavar="PATH", help="path to the tensorflow weights")
    ...
    g = Generator(size, 256, n_mlp, channel_multiplier=args.channel_multiplier)
    ...
    if args.gen:
        ...
        g_train = Generator(size, 256, n_mlp, channel_multiplier=args.channel_multiplier)
    ...
    z = np.random.RandomState(0).randn(n_sample, 256).astype("float32")
